...
public:
	...
	void SetHalfWidth(float half_width) { m_CuboidHalfDimensions.x = fabs(half_width); m_Radius = m_CuboidHalfDimensions.Length(); }
	void SetHalfHeight(float half_height) { m_CuboidHalfDimensions.y = fabs(half_height); m_Radius = m_CuboidHalfDimensions.Length();}
	void SetHalfDepth(float half_depth) { m_CuboidHalfDimensions.z = fabs(half_depth); m_Radius = m_CuboidHalfDimensions.Length();}
